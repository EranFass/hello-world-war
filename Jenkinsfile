...
mvn clean package'''
    ...
    stage('Sonarcloud - code analysis') {
      steps {
        sh '''mvn verify org.sonarsource.scanner.maven:sonar-maven-plugin:sonar -Dsonar.projectKey=EranFass_hello-world-war -Dsonar.login=af37292cd52b281c3b2ea0c8718ca685880cb71d
'''
      }
    }
